...
apt-get -y install chrony openssh-server expect espeak ros-indigo-joy ros-indigo-usb-cam ros-indigo-openni2* ros-indigo-hokuyo-node ros-indigo-dynamixel-motor 
